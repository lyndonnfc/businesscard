...
public class HttpManager {
    ...
    public void getCode(String phone, StringCallback callback){
        OkGo.<String>post(ApiService.GET_CODE_URL)
                .tag(this)
                .params("phone", phone)
                .execute(callback);
    }
     ...
     * @param callback callback
     */
    public void login(String verifyCode, String mobile, StringCallback callback){
    ...
    public void getCardList(long uid, String keyword, StringCallback callback){
        OkGo.<String>post(ApiService.GET_CARD_LIST)
                .tag(this)
                .params("uid", uid)
     ...
     * @param callback callback
     */
    public void updateCard(long uid, String realName, String phone, String position,
                           String department, String companyName, String email, String address,
                           StringCallback callback){
